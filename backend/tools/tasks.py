...
#     "If you need more context, call 'fetch_conversation_history_from_api' with a JSON object like "
#     "{'function': 'fetch_conversation_history_from_api', 'parameters': {'limit': 5}}. "
...
#     "Evaluate your 'final_answer': if it’s not conversational, engaging, or suitable for direct user interaction via TTS, "
#     "call 'rephrase_for_tts' with a JSON object like {'function': 'rephrase_for_tts', 'parameters': {'initial_response': 'your_final_answer'}} "
#     "to transform it into a friendly, direct response. The final output to the user should always be conversational and engaging."
# )
...
#     """Fetch conversation history from the /history/ endpoint based on LLM-provided limit."""
#     try:
...
#     rephrased = response_message["content"]
...
#                     if msg.status in ('errored', 'killed'):
#                         break
#                     msg.ai_action_log = 'agent-thinks'  # Still thinking while rephrasing
#                     msg.save()
